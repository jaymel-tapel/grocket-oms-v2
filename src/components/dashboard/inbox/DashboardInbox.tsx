      ...
      <div className="h-full rounded-sm border border-stroke bg-white border-solid dark:border-strokedark dark:bg-boxdark xl:flex">
        <div className="hidden h-full flex-col xl:flex xl:w-1/4">
          <div className="sticky flex justify-between border-b border-stroke px-6 py-2">
            ...
            <span className="rounded-md border bg-gray-200   px-2 py-2 mt-4 h-6 mb- text-base font-medium text-black ">
              1
            </span>
          </div>
          <div className="flex max-h-full flex-col overflow-auto p-5">
            <form className="sticky mb-7">
              <input
                type="text"
                className="w-full rounded border border-stroke bg-[#EFF4FB] py-2.5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2"
                placeholder="Search..."
              />
            ...
            <div className="no-scrollbar max-h-full space-y-2.5 overflow-auto">
              <div className="flex cursor-pointer items-center border rounded bg-[#EFF4FB] py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark">
          ...
          <div className="no-scrollbar max-h-full space-y-3.5 overflow-auto px-6 py-7.5">
            <div className="mr-auto max-w-full ">
              ...
              <div
                ...
                className="mb-2.5 border rounded-tl-none rounded-2xl bg-[#EFF4FB] py-3 px-5"
              >
                <p>
            ...
            <div className="ml-[11.4rem] max-w-125">
              <div
                style={{ maxWidth: "fit-content" }}
                className="mb-2.5  rounded-2xl border rounded-br-none bg-[#41B2E9] py-3 px-5"
              >
            ...
            <div className="ml-auto max-w-content">
              <div
                style={{ maxWidth: "fit-content" }}
                className="mb-2.5 rounded-2xl border rounded-br-none bg-[#41B2E9] py-3 px-5"
              >
            ...
            <form className="flex items-center gap-2 justify-between space-x-4.5">
              <div className="relative w-full">
                <input
                  ...
                  className="h-14 w-full rounded-md border border-stroke bg-gray pl-5 pr-19 text-black placeholder-body outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2 dark:text-white"
                />
