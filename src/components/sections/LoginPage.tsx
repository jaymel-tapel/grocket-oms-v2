  ...
  return (
    <section className="rounded-sm  border border-stroke bg-white shadow-default  ">
      <div className="flex flex-wrap items-center">
        ...
        <div className=" py-32 px-32  border-stroke h-[99vh] bg-[#F1F5F9] max-sm:px-10  max-sm:h-full max-lg:py-10 max-lg:w-screen max-lg:h-full xl:w-1/2 max-xl:w-screen xl:border-l-2">
